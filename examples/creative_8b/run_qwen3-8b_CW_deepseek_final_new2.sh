...
/root/miniconda3/envs/verl/bin/python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="qwen3_8b_deepseek_final_1_new2_20251224_170159" \
    trainer.n_gpus_per_node=8 \
    trainer.nnodes=1 \
    trainer.save_freq=10 \
    trainer.test_freq=5 \
    trainer.total_epochs=2 \
    trainer.default_local_dir=/data/qingnan/temp/verl_grpo_example_CW_2/qwen3_8b_deepseek_final_1_new2_20251224_170159 \
