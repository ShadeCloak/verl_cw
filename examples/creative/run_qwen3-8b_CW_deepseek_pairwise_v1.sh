...
python3 -m verl.trainer.main_ppo \
    ...
    reward_model.gpu_memory_utilization=0.5 \
    reward_model.prompt_length=30000 \
    reward_model.response_length=5000 \
    ...
    +reward_model.data_processor_config.pairwise_preprocess_fn_name=construct_deepseek_grm_inputs_pairwise \
    +reward_model.data_processor_config.pairwise_postprocess_fn_name=convert_deepseek_grm_pairwise_output_to_comparison \
    ...
    trainer.experiment_name="qwen3_8b_function_rm_pairwise_$TIMESTAMP" \
