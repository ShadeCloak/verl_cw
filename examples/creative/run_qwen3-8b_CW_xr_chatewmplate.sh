...
/workspace/chrihan/miniconda3/envs/verl_train_sa_1/bin/wandb login fe3a3f867639b3d57b39d7af7d0527150fc052fe --relogin
...
/workspace/chrihan/miniconda3/envs/verl_train_sa_1/bin/python3 -m verl.trainer.main_ppo \
    ...
    reward_model.max_num_batched_tokens=150000 \
    ...
    trainer.experiment_name="qwen3_8b_chattemplate_nothink_${TIMESTAMP}" \
